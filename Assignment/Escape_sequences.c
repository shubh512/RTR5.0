...
int main(void)
{
    ...
    //0x41 Is The Hexadecimal Code For Letter 'A'. 'xhh' Is The Place-holder For 'x' Followed By 2 digits (hh), altogether forming a Hexadecimal Number. printf("Demonstrating \102 Using \\000 Escape Sequence \n\n"); //102 Is The Octal Code For Letter 'B'. 'ooo' Is The Place-holder For 3 Digits Forming An Octal Number.
    return(0);
}